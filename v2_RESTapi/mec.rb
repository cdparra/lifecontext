...
def pointArrayDistance(points)

  #points = Array.new(n)
  #points[0] = Point.new(663700.1346854661,5103632.746654801)
  #points[1] = Point.new(508079.5338977631,4352401.249663794)
  #points[2] = Point.new(290051.357073518,5035430.56266659)
  #points[3] = Point.new(492003.2810032437,4906020.113294693)
