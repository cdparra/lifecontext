...
TT.initialize = function(callback) {
...
TT.preloader.initialize = function() {
	...
	spritesImage.src = "sprites.new.logo.png";
	frontImage.src = "front-cover.jpg";
	backImage.src = "back-cover-old.jpg";
	rightImage.src = "right-page-old.jpg";
	leftImage.src = "left-page-old.jpg";
	repeatImage.src = "repeat-x.png";
	paperImage.src = "right-page-paper.jpg";
	leftFlippedImage.src = "left-page-flipped-old.jpg";
	backImageFlipped.src = "back-cover-old-flipped.jpg";
};
...
TT.storage.activateCurrentPageAndSetPageCount = function() {
	...
	$origArticle.attr("id", "1");
	$("#pages section:not(#1)").each(function(i) {
...
TT.pageflip.createTextures = function() {
	TT.pageflip.flippedLeftPage = $("<img>",{src:$("#left-page img").attr("data-src-flipped"),width:$("#left-page img").attr("width"),height:$("#left-page img").attr("height")})[0];
	TT.pageflip.flippedBackCover = $("<img>",{src:$("#back-cover img").attr("data-src-flipped"),width:$("#back-cover img").attr("width"),height:$("#back-cover img").attr("height")})[0];
...
TT.paperstack.updateStack = function(overrideProgress) {
	...
	console.log(availablePapers+" fogli disponibili");
	var visiblePapers = availablePapers - parseInt(TT.navigation.getPage());
	console.log(visiblePapers+" fogli visibili");
	if (visiblePapers != 0) {
...
TT.navigation.getPage = function() {
...
TT.navigation.goToPage = function(articleId, pageNumber, fromHistoryChange) {
	console.log("vado a pagina" + pageNumber);
...
TT.navigation.updatePageVisibility = function(targetPage, direction, steps) {
	...
	if (targetPage.hasClass('page-image')) {
		mapResize(parseInt(targetPage.attr('id')));
	}
};
